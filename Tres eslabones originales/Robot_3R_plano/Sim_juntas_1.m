...
Vtheta1=((30/T^3)*tin.^2-(60/T^4)*tin.^3+(30/T^5)*tin.^4)*(theta1_fin(1)-theta1_in(1));
Vtheta2=((30/T^3)*tin.^2-(60/T^4)*tin.^3+(30/T^5)*tin.^4)*(theta2_fin(1)-theta2_in(1));
Vtheta3=((30/T^3)*tin.^2-(60/T^4)*tin.^3+(30/T^5)*tin.^4)*(theta3fin_1-theta3in_1);
...
wmax = L1*L2*sin(pi/2);
theta1_est = double(theta1_in(1)+((10/T^3)*tin.^3-(15/T^4)*tin.^4+(6/T^5)*tin.^5)*(theta1_fin(1)-theta1_in(1)));
theta2_est = double(theta2_in(1)+((10/T^3)*tin.^3-(15/T^4)*tin.^4+(6/T^5)*tin.^5)*(theta2_fin(1)-theta2_in(1)));
theta3_est = double(theta3in_1+((10/T^3)*tin.^3-(15/T^4)*tin.^4+(6/T^5)*tin.^5)*(theta3fin_1-theta3in_1));
figure(3)
